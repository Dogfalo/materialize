...
Vel = $ ? $.Velocity : Velocity, function(a){
    ...
    function b(b){
        var c = {
            ...
            complete: void 0,
            dismissible: !0
        }, d = a(this), e = a("#lean-overlay");
        b = a.extend(c, b), e.length || (e = a('<div id="lean-overlay"></div>'), a("body").append(e)), b.dismissible && (e.click(function(){
            d.closeModal(b)
        }), a(document).on("keyup.leanModal", function(a){
            27 === a.keyCode && d.closeModal(b)
        })), d.css({display: "block", opacity: 0}).find(".modal-close").click(function(a){
            d.closeModal(b)
        }), e.css({display: "block", opacity: 0}).velocity({opacity: b.opacity}, {
            duration: b.in_duration,
            queue: !1,
            ease: "easeOutCubic"
        }), d.hasClass("bottom-sheet") ? d.velocity({bottom: 0, opacity: 1}, {
            duration: b.in_duration,
            queue: !1,
            ease: "easeOutCubic",
            complete: function(){
        ...
        }) : d.css({top: "4%"}).velocity({top: "10%", opacity: 1}, {
            duration: b.in_duration,
            queue: !1,
            ease: "easeOutCubic",
            complete: function(){
    ...
    function c(b){
        var c = {out_duration: 250, complete: void 0}, d = a(this), e = a("#lean-overlay");
        b = a.extend(c, b), a(".modal-close").off(), a(document).off("keyup.leanModal"), e.velocity({opacity: 0}, {
            duration: b.out_duration,
            queue: !1,
            ease: "easeOutQuart"
        }), d.hasClass("bottom-sheet") ? d.velocity({bottom: "-100%", opacity: 0}, {
            duration: b.out_duration,
            queue: !1,
            ease: "easeOutCubic",
            complete: function(){
                e.css({display: "none"}), "function" == typeof b.complete && b.complete(), e.remove()
            }
        }) : d.fadeOut(b.out_duration, function(){
            d.css({top: 0}), e.css({display: "none"}), "function" == typeof b.complete && b.complete(), e.remove()
        })
    }
    ...
    function d(b){
        return this.each(function(){
            ...
            c.click(function(d){
                d.preventDefault();
                var e = c.attr("href") || "#" + c.data("target");
                a(e).openModal(b)
            })
        })
    }

    a.fn.extend({openModal: b, closeModal: c, leanModal: d})
}(jQuery), function(a){
    ...
    a(document).ready(function(){
        a.fn.reverse = [].reverse, a(document).on("mouseenter.fixedActionBtn", ".fixed-action-btn", function(b){
            var c = a(this);
            c.find("ul .btn-floating").velocity({scaleY: ".4", scaleX: ".4", translateY: "40px"}, {duration: 0});
            var d = 0;
            ...
            var c = a(this);
            c.find("ul .btn-floating").velocity("stop", !0), c.find("ul .btn-floating").velocity({
                opacity: "0",
                scaleX: ".4",
                scaleY: ".4",
                translateY: "40px"
