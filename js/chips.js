(function ($, Vel) {
  ...
  class Chips {
    ...
    deleteChip(chipIndex) {
      let chip = this.chips[chipIndex]; // Save the to be deleted chip
      ...
      if (typeof(this.options.onChipDelete) === 'function') {
        this.options.onChipDelete.call(this, this.$el, chip); // and pass it to the callback
      }
    }
    ...
    selectChip(chipIndex) {
      ...
      if (typeof(this.options.onChipSelect) === 'function') {
        this.options.onChipSelect.call(this, this.$el, $chip); // just $chip; this.$chip is undefined.
      }
    }
  }
