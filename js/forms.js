(function ($) {
    ...
    ****************/
    ...
    var $bodyElement = $('.squirro-body');
    if (window && window.config && window.config.$squirroBody) {
      $bodyElement = window.config.$squirroBody;
    }
    $bodyElement.on('mouseup touchend', range_wrapper, function() {
